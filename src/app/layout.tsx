...
import { SubscriptionPlan, PLAN_DETAILS } from '@/lib/constants'
...
export default function BillingPage() {
  ...
  const isPaid = billingData.subscriptionStatus === 'ACTIVE' && currentPlan !== 'FREE'
  const planData = PLAN_DETAILS[currentPlan] || PLAN_DETAILS.FREE
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
          ...
          <div className="bg-white border-4 border-[#1a1a1a] p-6 shadow-[8px_8px_0px_0px_rgba(26,26,26,1)]">
            ...
            <div className="flex gap-4 mb-6">
              ...
              >
                Monthly<br />
                <span className="text-sm">$49/mo</span>
              </button>
              <button
              ...
              >
                Annual 🎉<br />
                <span className="text-sm">$490/yr</span>
              </button>
            </div>
            <button
              onClick={() => handleUpgrade(selectedPlan === 'monthly' ? MONTHLY_PRICE_ID : ANNUAL_PRICE_ID)}
            ...
            >
              {billingLoading ? 'Redirecting...' : `Subscribe ${selectedPlan === 'monthly' ? '$49/mo' : '$490/yr'}`}
            </button>
          </div>
          ...
          <div className="bg-[#1a1a1a] border-4 border-[#1a1a1a] p-6 shadow-[8px_8px_0px_0px_rgba(26,26,26,1)] flex items-center justify-between gap-6">
            <div className="text-white">
              ...
              <p className="font-bold opacity-70 text-sm uppercase">Unlock Pro features, unlimited orders, and priority support.</p>
            </div>
            <button
